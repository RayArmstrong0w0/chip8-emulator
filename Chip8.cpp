...
bool Chip8::loadROM(const std::string& caminhoArquivo){
...
void Chip8::cycle() {
    ...
    switch (tipoComando) {
        ...
        case 0x5:
            ...
            std::cout << "Instrucao 0x5: Se V[" << (int)x << "] == V[" << (int)y << "]" << std::endl;
            break;
        ...
        case 0x9:
            ...
            std::cout << "Instrucao 0x9: Se V[" << (int)x << "] != V[" << (int)y << "]" << std::endl;
            break;

        case 0xA:
            I = nnn;
            std::cout << "Instrucoes 0xA: Registradores I atualizado para 0x"
        ...
        default:
            std::cout << "Instrucao nao reconhecida: 0x"
                      << std::hex << opcode << std::dec << std::endl;
            break;
    }

    std::cout << "Opcode lido: 0x" << std::hex << opcode << std::dec << std::endl;
}